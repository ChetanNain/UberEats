...
export default class AddRestaurant extends Component {
  constructor() {
    ...
    this.restaurantDescriptionHandler =
      this.restaurantDescriptionHandler.bind(this);
  ...
  async loadBasicDetails() {
    const res = await axios.get(
      "http://localhost:3001/basicDetail/" +
        localStorage.getItem("restaurantID")
    );
    this.setState({
      restaurantName: res.data[0].name,
      restaurantLocation: "Route 53, Net york",
      restaurantCountry: res.data[0].country,
      restaurantProvience: res.data[0].provience,
      restaurantPincode: res.data[0].pincode,
      restaurantDescription: res.data[0].description,
    });
  }

  async loadMenuItems() {
    const menuItems = await axios.get(
      "http://localhost:3001/menuDetails/" +
        localStorage.getItem("restaurantID")
    );
    ...
    return (
      <div style={{ borderBottom: "1px solid black", padding: "10px" }}>
        ...
        >
          ...
          <a class="link" onClick={() => this.removeExstingMenuItem(data.id)}>
            Remove
          </a>
        </div>
      </div>
  ...
  handleCountryChange(e) {
    ...
    if (selectedCountry == "CA") {
      this.setState({
        provienceForSelectedContry: this.countryAndProvince[1].states,
      });
  ...
  saveMenu() {
    if (
      this.validateBasicFromDetail() == false ||
      this.validateMenuForm() == false
    )
      return;
    const body = {
    ...
    axios
      .post("http://localhost:3001/addRestaurantMenu", body)
      .then((response) => {
    ...
    return (
      <div class="container">
        ...
        <div class="d-flex justify-content-evenly">
          <button class="btn btn-success" onClick={this.saveRestaurantData}>
            Save Basic Details
          </button>
        </div>

        <h5>Menu Details</h5>
        <button class="btn btn-primary mt-3" onClick={this.openModal}>
          Add +
        </button>
          ...
          <div class="menuForm">
            ...
            <div class="d-flex justify-content-between">
              <input
                ...
                onChange={this.handleDishIngredients}
              />
            ...
            <div class="d-flex justify-content-between">
              ...
              <select onChange={this.handleDishCategory}>
            ...
            <div class="d-flex justify-content-between">
              <select onChange={this.handleDishType}>
            ...
            <div class="d-flex justify-content-between">
              <textarea
                ...
                onChange={this.handleDishDescription}
              />
            </div>

            <div class="d-flex justify-content-evenly">
              <button class="btn btn-success" onClick={this.saveMenu}>
                Save Dish
              </button>
            </div>
          </div>
