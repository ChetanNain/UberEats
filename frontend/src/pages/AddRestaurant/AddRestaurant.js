...
export default class AddRestaurant extends Component {
    ...
    async loadMenuItems(){
        ...
        const menuItems = await axios.get(`http://${window.location.hostname}:4000/menuDetails`, headerConfig);
    ...
    removeExstingMenuItem(id){
        console.log(id);
        axios.get(`http://${window.location.hostname}:4000/removeItem/${id}`)
    ...
    generateMenuList(data){
        ...
        <div style={{justifyContent: 'space-between', display: 'flex', alignItems: 'center' }}>
            ...
            <span>{data.mainIngredients || data.dishIngredients}</span>
    ...
    saveMenu(){
        ...
        console.log(body);
         axios.post(`http://${window.location.hostname}:4000/addRestaurantMenu`, body, headerConfig).then(response=>{ 
           this.loadMenuItems();
    ...
    saveRestaurantData(){
        ...
        const headerConfig = {
         ...
         axios.post(`http://${window.location.hostname}:4000/addRestaurantBasicDetail`, basicDetails, headerConfig).then(res=>{
        ...
        return (
          <div class="container" >
            ...
            <select
                ...
                onChange={this.handleRestaurantType.bind(this)}
              >
