...
export default function Login(props) {
    ...
    function validateForm(){
        if( loginData.mobileNumber &&  !validateEmail(loginData.mobileNumber.payload)){
            ...
            axios.post(`http://${window.location.hostname}:4000/login`, {mobileNumber: loginData.mobileNumber.payload, password: loginData.password.payload, role: loginData.userType.payload}).then(res=>{
