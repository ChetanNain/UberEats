...
export default function Checkout(props) {
  ...
  return (
    <div id="RegisterPage" style={{ background: "#F5F5F5" }}>
      <div>
        <p
          style={{ borderBottom: "1px solid gray", fontSize: "12px" }}
          class="py-3"
        >
          ...
          full responsibility to it once delivered.
        </p>
        ...
        >
          <p style={{ fontSize: "12px" }}>
            {" "}
            Delivery people are critical to our communities at this time. you
            may add a tip to say thanks.
          </p>
        </div>
